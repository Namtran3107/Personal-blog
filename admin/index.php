...
$st = $blog_contact->read_all();
$stm = $blog_post->read_all();
                                        ...
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2>
                                                    <?php 
                                                    // echo $hits[0];
                                                    $fileContent = file_get_contents('include/count.txt');
                                                    echo $fileContent;
                                                     ?>
                                                </h2>
                                                <span>Member</span>
